...
internal class DedicatedCommander : UnitFactComponentDelegate
{
    public override void OnTurnOn()
    {
        ...
        {
            var newEntry = new UnitPartAbilityModifiers.ActionEntry(base.Fact, UnitCommand.CommandType.Move, blueprintAbilityReference);
